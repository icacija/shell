...
echo "Installing Iconv, Mbstring, Opcache, Fileinfo and Soap"
yum install php83-php-iconv php83-php-mbstring ea-php83-php-opcache ea-php83-php-fileinfo ea-php83-php-soap
